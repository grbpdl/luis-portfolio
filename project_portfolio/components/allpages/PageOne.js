  ...
  return (
        <div className="flex flex-col min-h-screen  bg-[#d9d9d9]">
          ...
          <div className="flex flex-col flex-grow">
            <div
              className={`flex flex-grow  items-center justify-center text-[30vw] leading-none font-bold text-[#2b2b2b]`}
            >
            ...
            <div className="flex justify-center">
              <p
                className={` text-[10vw] text-black m-0 p-0`}
                style={{
                  textShadow:
            ...
            <div className="mb-8 flex justify-center">
              <p
                ...
                className={`text-[5vw] text-[#004aad] m-0 p-0`}
              >
